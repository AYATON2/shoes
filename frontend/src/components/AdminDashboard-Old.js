          ...
          <div className="overview-grid">
            <div className="overview-card">
              <div className="card-header-modern">
                ...
                <button className="btn btn-outline-primary btn-sm" onClick={() => setActiveTab('users')}>
            ...
            <div className="overview-card">
              <div className="card-header-modern">
                ...
                <button className="btn btn-outline-success btn-sm" onClick={() => setActiveTab('products')}>
                  <i className="fas fa-arrow-right"></i>
                </button>
              </div>
              <div className="table-container">
